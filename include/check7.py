            ...
            for i in range(len(json_cis)):
                ...
                try:
                    ...
                    for j in range(len(json_cis2)):
                        if (json_cis2[j]['virtualMachineExtensionType']=="MicrosoftMonitoringAgent"):
                            chk71=chk71+('VM: %s %s<br></li>' %(vm,json_cis2[j]['virtualMachineExtensionType'],))
                            passvalue71=passvalue71+1
                            passed71='<font color="green">Passed </font>('
                        elif ("Antimalware" in json_cis2[j]['virtualMachineExtensionType']):
